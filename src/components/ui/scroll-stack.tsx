...
const ScrollStack = ({
  ...
  useLayoutEffect(() => {
    ...
    // Native scroll and resize event listeners as robust fallback/sync mechanism
  ...
  return (
    <div
      ...
      ref={scrollerRef}
    >
      <div className={useWindowScroll ? "pt-12 px-4 pb-[24rem] relative" : "scroll-stack-inner"}>
        {children}
